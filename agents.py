...
PIPELINE_AGENTS = {
    ...
    "seo_converter": {
        ...
        "system_prompt": (
            ...
            "- 중간 CTA: 본문 흐름 안에서 자연스러운 1줄. \"필요하시면 참고만 하셔도 됩니다\" 톤\n"
            "- 마무리 CTA: 2~3줄. 공감 마무리→신뢰 한줄→행동 유도(카카오톡)\n"
            "- CTA는 가운데 정렬. 독자 시선이 자연스럽게 모이도록\n"
            "- 강요/긴급성 표현 절대 금지 (\"지금 바로\", \"놓치지 마세요\" 등)\n\n"
            "[푸터 슬로건] 15~25자 1줄. 가운데 정렬. 여운을 남기는 톤\n\n"
            "[메타 — Apple 간결함]\n"
            "- 타이틀: 군더더기 없이 핵심만. 40자 이내\n"
            "- 디스크립션: 한 문장에 가치+차별점+초대. 150자 이내\n"
            "- OG 타이틀: 호기심 유발하되 과장 금지\n\n"
