...
[카피 리듬]
1. 문장 리듬: "강력하게. 비상하다." — 마침표로 끊는 짧은 호흡이 핵심
2. 문장 길이: 25~35자 목표. 50자 넘으면 반드시 두 문장으로 분리
3. 문단: 2~3문장 이내. 그 이상은 반드시 새 문단
4. 여백: 문단 사이 빈 줄 필수. 텍스트의 40%는 여백. "여백이 곧 디자인"

[타이포 위계]
5. 헤드라인(H2): 2~6단어. 마침표로 끝남 (예: "🔍 관리의 시작점.")
6. 서브헤드라인: 1문장, 15자 이내
7. 볼드(**): 글 전체에서 3회 이내. 핵심 숫자/결론에만 사용
8. 이모지: H2 소제목에만 1개. 본문에 이모지 절대 금지

[색상 위계 — Apple 실측]
9. 본문 텍스트: 진한 회색(#1d1d1f) — 순수 검정 아님
10. 보조 텍스트(인용구/캡션): 중간 회색(#6e6e73)
11. 구분선: 연한 회색(#d2d2d7)
12. 인용구(>): 좌측 파란 테두리 + 연회색 배경. 핵심 메시지에만 사용
13. 강조 숫자: 볼드 + 독립 문장으로 배치 (예: "**연간 4,000만원.** 한 건물에서 절감한 금액입니다.")

[어감/톤]
14. 숫자 표현: 문장 속에 자연스럽게 ("최대 40%", "연간 4,000만원")
15. 감정 단어: "놀랄 만큼", "거뜬하게", "술술", "척척" (과장/감탄사 남발 금지)
16. 어미 변주: ~합니다/~입니다 80% + ~죠/~세요 20% (단조로움 방지)
17. CTA: "더 알아보기" 식의 동사+목적어 구조. 강요/긴급성 금지

[금지]
18. "~할 수 있습니다"(→"~됩니다"), "~것입니다"(→"~입니다")
19. "또한", "한편", "그리고" 남발 (접속사 최소화)
20. 과한 볼드, 이모지 남발, 색깔 글씨, HTML 태그

[구조]
21. 섹션 구조: 헤드라인 → 서브헤드 → 본문(2~3문장) × 2~3개 → 다음 섹션
22. 섹션 사이: 빈 줄 2개 이상 (충분한 호흡)
"""
